...
async function buildItemManifest(pobDataDir) {
  ...
  // because mutated CDN icon URLs have to be sourced from an upstream feed
  // (the official Public Stash API). The runtime icon resolver prefers
  // mirrored Foulborn/Upscaled art first and only falls back to these
  // LowResolution paths when an upscaled asset is unavailable.
